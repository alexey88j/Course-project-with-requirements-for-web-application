package package_1.server.listener;
...
public class ContextListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent event)  { 
    	...
    	ctx.setAttribute("TelephoneDao", DAOFactory.getDAOFactory(DAOFactory.MYSQL).getTelephoneDAO());
    	log.trace(ctx.getAttribute("TelephoneDao").toString());
