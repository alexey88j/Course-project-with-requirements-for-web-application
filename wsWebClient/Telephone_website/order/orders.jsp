...
<%-- PAGE VARIABLES --%>
	...
	<jsp:useBean id="odp" class="package_1.shared.Pagination" scope="page" >
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="tabs">
						<ul class="nav nav-tabs">
							...
							<li ${search.equals("inprogress") ? 'class="active"' : '' }><a href="${context }/order/orders.jsp?search=inprogress">В исполнении</a></li>
