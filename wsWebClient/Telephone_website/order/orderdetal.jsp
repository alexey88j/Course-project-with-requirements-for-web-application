...
<jsp:useBean id="util" class="package_1.client.Util"></jsp:useBean>
			...
			<c:when test="${empty error }">
				...
				<div class="row col-md-12"> -->
					<table class="table table-bordered table-striped">
						...
						<tbody>
							<c:forEach var="telephone" items="${order.items }">
								<tr>
									...
									<td><p class="text-center">${telephone.value}</p></td>
									<td><p class="text-right">${telephone.key.price}</p></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
